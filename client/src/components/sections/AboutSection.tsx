      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-dark-500 dark:text-dark-200 max-w-2xl mx-auto">
            Learn a bit about my background, skills, and what drives me as a
            developer.
          </p>
        </motion.div>
        ...
        >
          <motion.div variants={fadeIn("right", 0.3)} className="space-y-6">
            <p className="text-lg">
              ...
              experience specializing in the MERN stack. I have a proven track
              record of optimizing application performance and implementing
              AI-driven solutions that enhance user experience and business
              metrics.
            </p>
            <p className="text-lg">
              My journey in web development began with a Bachelor's degree in
              Computer Applications, and I've since worked with various
              technologies to build high-performance, scalable applications. I'm
              passionate about creating clean, efficient code and developing
                ...
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <svg
                      ...
                      className="text-primary dark:text-primary mr-2 w-5 h-5"
                    >
            ...
            >
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-sm font-mono text-dark-500 dark:text-dark-200">
                    3+ years experience
                  </div>
                </div>
                <div className="flex items-center gap-2">
