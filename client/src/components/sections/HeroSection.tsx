      ...
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-24">
        ...
        >
          <div className="space-y-6">
            ...
            >
              Full Stack Developer with 3+ years of experience in MERN stack development. Specialized in building high-performance web applications with expertise in React.js, Next.js, Node.js, and cloud services.
            </motion.p>
